...
public class SSLCertificateMockServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        when(nclmMockUtil.getRevocationMockResponse()).thenReturn(getRevocationMockResponse());
        when(nclmMockUtil.getMockLoginDetails()).thenReturn(getMockLoginDetails());
    ...
    public CertificateData getDeleteCertMockResponse(){
        CertificateData certificateData = new CertificateData();
        certificateData.setCertificateId(1234);
        certificateData.setExpiryDate("10-10-2020");
        certificateData.setCreateDate("10-20-2020");
        return certificateData;
    }
    ...
    public CertificateData getMockCertificateData(){
        ...
        CertificateData certificateData = new CertificateData();
        certificateData.setCertificateName("testcert.t-mobile.com");
    ...
    @Test
    public void generateSSLCertificate_External_Success_With_Mockdata() throws Exception {
        ReflectionTestUtils.setField(sSLCertificateService, "nclmMockEnabled", "true");
        String jsonStr = "{  \"username\": \"testusername1\",  \"password\": \"testpassword1\"}";
