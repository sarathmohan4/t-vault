...
public class SSLCertificateAWSRoleServiceTest {
    ...
    @Test
    public void testCreateAWSRoleForSSLSuccessForAdmin() throws Exception {
        ResponseEntity<String> responseEntityExpected = ResponseEntity.status(HttpStatus.OK).body("{\"messages\":[\"AWS Role created \"]}");
        token = "5PDrOhsy4ig8L3EpsJZSLAMg";
    ...
    @Test
    public void testCreateIAMRoleForSSLSuccessForAdmin() throws Exception {
        ResponseEntity<String> responseEntityExpected = ResponseEntity.status(HttpStatus.OK).body("{\"messages\":[\"AWS Role created \"]}");
        token = "5PDrOhsy4ig8L3EpsJZSLAMg";
        userDetails = getMockUser(true);
        AWSIAMRole awsiamRole = new AWSIAMRole();
    ...
    @Test
	public void testAddAwsIAMRoleToSSLCertificateSuccssfullyForAdmin() throws Exception {
		SSLCertificateMetadataDetails certificateMetadata = getSSLCertificateMetadataDetails();
        ResponseEntity<String> responseEntityExpected = ResponseEntity.status(HttpStatus.OK).body("{\"messages\":[\"AWS Role successfully associated with SSL Certificate\"]}");
        token = "5PDrOhsy4ig8L3EpsJZSLAMg";
        userDetails = getMockUser(true);
    ...
    @Test
	public void testAddAwsEC2RoleToSSLCertificateSuccssfullyForAdmin() throws Exception {
		SSLCertificateMetadataDetails certificateMetadata = getSSLExternalCertificateRequest();
        ResponseEntity<String> responseEntityExpected = ResponseEntity.status(HttpStatus.OK).body("{\"messages\":[\"AWS Role successfully associated with SSL Certificate\"]}");
        token = "5PDrOhsy4ig8L3EpsJZSLAMg";
        userDetails = getMockUser(true);
    ...
    @Test
	public void testAddAwsEC2RoleToSSLCertificateMetadataFailureForAdmin() throws Exception {
		SSLCertificateMetadataDetails certificateMetadata = getSSLCertificateMetadataDetails();
        ...
        when(certificateUtils.hasAddOrRemovePermission(userDetails, certificateMetadata)).thenReturn(true);
        when(ControllerUtil.updateMetadata(Mockito.anyMap(),Mockito.anyString())).thenReturn(updateMetadataResponse);
        Response revertConfigureAWSRoleResponse = getMockResponse(HttpStatus.OK, true, "");
        when(awsAuthService.configureAWSRole(Mockito.anyString(), Mockito.anyString(), Mockito.anyString())).thenReturn(revertConfigureAWSRoleResponse);
        when(tokenUtils.getSelfServiceToken()).thenReturn(token);
        ResponseEntity<String> responseEntityActual =  sslCertificateAWSRoleService.addAwsRoleToSSLCertificate(userDetails, token, certificateAWSRole);
        assertEquals(HttpStatus.INTERNAL_SERVER_ERROR, responseEntityActual.getStatusCode());
        assertEquals(responseEntityExpected, responseEntityActual);
    ...
    @Test
    public void testAddAwsRoleToSSLCertValidationFailureEmptyRequest() throws Exception {
        ResponseEntity<String> responseEntityExpected = ResponseEntity.status(HttpStatus.BAD_REQUEST).body("{\"errors\":[\"Invalid input values\"]}");
        token = "5PDrOhsy4ig8L3EpsJZSLAMg";
        userDetails = getMockUser(false);
        CertificateAWSRole certificateAWSRole = new CertificateAWSRole("certificatename.t-mobile.com", "role1", "read", "inte");
        ...
        String [] policies = {"o_externalcerts_certificatename.t-mobile.com"};
        when(policyUtils.getCurrentPolicies(userDetails.getSelfSupportToken(), userDetails.getUsername(), userDetails)).thenReturn(policies);
        ResponseEntity<String> responseEntityActual =  sslCertificateAWSRoleService.addAwsRoleToSSLCertificate(userDetails, token, null);
    ...
    @Test
    public void testAddAwsRoleToSSLCertValidationFailureInvalidAccess() throws Exception {
        ResponseEntity<String> responseEntityExpected = ResponseEntity.status(HttpStatus.BAD_REQUEST).body("{\"errors\":[\"Invalid input values\"]}");
        token = "5PDrOhsy4ig8L3EpsJZSLAMg";
        userDetails = getMockUser(false);
        CertificateAWSRole certificateAWSRole = new CertificateAWSRole("certificatename.t-mobile.com", "role1", "rotate", "internal");
        when(tokenUtils.getSelfServiceToken()).thenReturn("5PDrOhsy4ig8L3EpsJZSLAMg");
        String [] policies = {"o_externalcerts_certificatename.t-mobile.com"};
        when(policyUtils.getCurrentPolicies(userDetails.getSelfSupportToken(), userDetails.getUsername(), userDetails)).thenReturn(policies);
        ResponseEntity<String> responseEntityActual =  sslCertificateAWSRoleService.addAwsRoleToSSLCertificate(userDetails, token, certificateAWSRole);
    ...
    @Test
    public void testAddAwsRoleToSSLCertValidationFailureInvalidCertname() throws Exception {
        ResponseEntity<String> responseEntityExpected = ResponseEntity.status(HttpStatus.BAD_REQUEST).body("{\"errors\":[\"Invalid input values\"]}");
        token = "5PDrOhsy4ig8L3EpsJZSLAMg";
        userDetails = getMockUser(false);
        CertificateAWSRole certificateAWSRole = new CertificateAWSRole("certificatename", "role1", "read", "internal");
        when(tokenUtils.getSelfServiceToken()).thenReturn("5PDrOhsy4ig8L3EpsJZSLAMg");
        String [] policies = {"o_externalcerts_certificatename.t-mobile.com"};
        when(policyUtils.getCurrentPolicies(userDetails.getSelfSupportToken(), userDetails.getUsername(), userDetails)).thenReturn(policies);
        ResponseEntity<String> responseEntityActual =  sslCertificateAWSRoleService.addAwsRoleToSSLCertificate(userDetails, token, certificateAWSRole);
    ...
    @Test
    public void testAddAwsRoleToSSLCertValidationFailureInvalidCertname1() throws Exception {
        ResponseEntity<String> responseEntityExpected = ResponseEntity.status(HttpStatus.BAD_REQUEST).body("{\"errors\":[\"Invalid input values\"]}");
        token = "5PDrOhsy4ig8L3EpsJZSLAMg";
        userDetails = getMockUser(false);
        CertificateAWSRole certificateAWSRole = new CertificateAWSRole("certificatename._t-mobile.com", "role1", "read", "internal");
        when(tokenUtils.getSelfServiceToken()).thenReturn("5PDrOhsy4ig8L3EpsJZSLAMg");
        String [] policies = {"o_externalcerts_certificatename.t-mobile.com"};
        when(policyUtils.getCurrentPolicies(userDetails.getSelfSupportToken(), userDetails.getUsername(), userDetails)).thenReturn(policies);
        ResponseEntity<String> responseEntityActual =  sslCertificateAWSRoleService.addAwsRoleToSSLCertificate(userDetails, token, certificateAWSRole);
    ...
    @Test
    public void testRemoveAwsRoleToSSLCertValidationFailureInvalidCertname() throws Exception {
        ResponseEntity<String> responseEntityExpected = ResponseEntity.status(HttpStatus.BAD_REQUEST).body("{\"errors\":[\"Invalid input values\"]}");
        token = "5PDrOhsy4ig8L3EpsJZSLAMg";
        userDetails = getMockUser(false);
        CertificateAWSRoleRequest certificateAWSRoleRequest = new CertificateAWSRoleRequest("certificatename", "role1", "internal");
        when(tokenUtils.getSelfServiceToken()).thenReturn("5PDrOhsy4ig8L3EpsJZSLAMg");
        String [] policies = {"o_externalcerts_certificatename.t-mobile.com"};
        when(policyUtils.getCurrentPolicies(userDetails.getSelfSupportToken(), userDetails.getUsername(), userDetails)).thenReturn(policies);
        ResponseEntity<String> responseEntityActual =  sslCertificateAWSRoleService.removeAWSRoleFromSSLCertificate(userDetails, token, certificateAWSRoleRequest);
    ...
    @Test
    public void testRemoveAwsRoleToSSLCertValidationFailureEmptyRequest() throws Exception {
        ResponseEntity<String> responseEntityExpected = ResponseEntity.status(HttpStatus.BAD_REQUEST).body("{\"errors\":[\"Invalid input values\"]}");
        token = "5PDrOhsy4ig8L3EpsJZSLAMg";
        userDetails = getMockUser(false);
        CertificateAWSRoleRequest certificateAWSRoleRequest = new CertificateAWSRoleRequest("certificatename.t-mobile.com", "role1", "internal");
        ...
        String [] policies = {"o_externalcerts_certificatename.t-mobile.com"};
        when(policyUtils.getCurrentPolicies(userDetails.getSelfSupportToken(), userDetails.getUsername(), userDetails)).thenReturn(policies);
        ResponseEntity<String> responseEntityActual =  sslCertificateAWSRoleService.removeAWSRoleFromSSLCertificate(userDetails, token, null);
